...
const d = [{
  ...
  , c = r => n.innerHTML = ` <i class="fa-solid fa-cart-shopping"> ${r.length} </i>`
  , l = () => {
    let r = localStorage.getItem("cartProductLS");
...
function p(r, s) {
    ...
    r === "add" ? a.textContent = `Product with ID ${s} has been added.` : a.textContent = `Product with ID ${s} has been deleted.`,
